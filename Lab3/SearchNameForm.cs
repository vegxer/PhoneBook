...
namespace Lab3
{
    ...
    {
        List<Note> PhoneNote;
        public SearchNameForm(List<Note> PhoneNote)
        {
            InitializeComponent();
        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            ...
            foreach (Note MyRecord in PhoneNote)
            {
                ...
                if (MyRecord.Surname.Contains(textBoxSurname.Text) &&
                MyRecord.Name.Contains(textBoxName.Text) && MyRecord.Patronymic.Contains(textBoxPatronymic.Text))
                {
